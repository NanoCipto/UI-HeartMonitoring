        ...
        body: LayoutBuilder(builder: (context, constraints) {
          ...
          return Stack(
            children: [
              ...
              Positioned(
                bottom:
                    parentHeight * 0.5, // Atur jarak tombol dari bawah layar
                left: 0,
                right: 0,
                child: Center(
                  child: ElevatedButton(
...
class HrvPages_2 extends StatelessWidget {
  const HrvPages_2({super.key});
...
class HrvPages_3 extends StatelessWidget {
  const HrvPages_3({super.key});
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              padding: EdgeInsets.symmetric(
                  horizontal: 80, vertical: 12), // Ukuran padding
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(15), // Border persegi dengan sudut melengkung
              ),
            ),
            child: Text(
            'DATA HASIL',
